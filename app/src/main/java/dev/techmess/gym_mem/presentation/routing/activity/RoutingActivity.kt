package dev.techmess.gym_mem.presentation.routing.activity
...
import dev.techmess.gym_mem.presentation.app.activity.AppActivity
import dev.techmess.gym_mem.presentation.onboarding.activity.OnboardingActivity
...
//        return
    ...
    private fun continueRouteWork() {
        lifecycleScope.launch(Dispatchers.Default) {
            ...
            val gymRegistered = appSharedPreferences.getBoolean(GYM_REGISTERED, false)
